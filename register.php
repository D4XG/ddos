...
<head>
  	...
  	<title>Inverse &mdash; Sign Up</title>
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-3">
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                ...
                                <div class="mt-6">
                                    <input type="text" name="captcha" id="captcha" placeholder="Captcha" required class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 transition-colors duration-500" />
                                </div>
                                <div class="mt-6 flex items-center">
                                   <img src="/rest/auth/captcha" class="mt-2" />
                                </div>
                            </div>
                            ...
                            <div class="flex items-center mt-6">
                                ...
                                <label for="checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="https://inverse.best/tos/" class="text-blue-600 dark:text-blue-500 hover:underline">terms and conditions</a>.</label>
                            </div>
                            <div class="mt-6">
